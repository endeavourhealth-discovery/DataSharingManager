...
export class AppMenuService implements  AbstractMenuProvider {
  static getRoutes(): Routes {
    return [
      ...
      { path: 'organisations/:mode', component: OrganisationComponent, data: {role: 'Viewer', helpContext: 'Organisations.htm'}},
      { path: 'organisation/:id/:mode', component: OrganisationEditorComponent, data: {role: 'Viewer', helpContext: 'Organisations.htm'}},
      { path: 'regions', component: RegionComponent, data: {role: 'Viewer', helpContext: 'Regions.htm'}},
      { path: 'region/:id/:mode', component: RegionEditorComponent, data: {role: 'Viewer', helpContext: 'Regions.htm'}},
      { path: 'value-sets', component: ValueSetsComponent, data: {role: 'Viewer', helpContext: 'Regions.htm'}},
      { path: 'cohorts', component: CohortComponent, data: {role: 'Viewer', helpContext: 'Cohorts.htm'}},
      { path: 'cohort/:id/:mode', component: CohortEditorComponent, data: {role: 'Viewer', helpContext: 'Cohorts.htm'}},
      ...
      { path: 'dataSets', component: DataSetComponent, data: {role: 'Viewer', helpContext: 'Data-sets.htm'}},
      { path: 'dataSet/:id/:mode', component: DataSetEditorComponent, data: {role: 'Viewer', helpContext: 'Data-sets.htm'}},
      { path: 'dpas', component: DataProcessingAgreementComponent, data: {role: 'Viewer', helpContext: 'Data-processing-agreements.htm'}},
      { path: 'dpa/:id/:mode', component: DataProcessingAgreementEditorComponent, data: {role: 'Viewer', helpContext: 'Data-processing-agreements.htm'}},
      { path: 'dsas', component: DataSharingAgreementComponent, data: {role: 'Viewer', helpContext: 'Data-sharing-agreements.htm'}},
      { path: 'dsa/:id/:mode', component: DataSharingAgreementEditorComponent, data: {role: 'Viewer', helpContext: 'Data-sharing-agreements.htm'}},
      { path: 'projects', component: ProjectComponent, data: {role: 'Viewer', helpContext: 'Projects.htm'}},
      { path: 'project/:id/:mode', component: ProjectEditorComponent, data: {role: 'Viewer', helpContext: 'Projects.htm'}},
      { path: 'audit', component: AuditComponent, data: {role: 'Viewer', helpContext: 'Audit.htm'}},
      { path: 'mySharingOverview', component: MySharingOverviewComponent, data: {role: 'Viewer', helpContext: 'My-sharing.htm'}},
      { path: 'reporting', component: ReportsComponent, data: {role: 'Admin', helpContext: 'Reporting.htm'}},
